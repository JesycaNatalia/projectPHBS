    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a style="float:right" class="btn btn-primary" href="{{ route('admin.dashboard.jawaban.create') }}/{{$id}}"><i class="bx bx-plus"></i><span class="menu-item text-truncate" data-i18n="Tambah Kuisioner">Tambah
                        Jawaban </span></a>
            </div>
            <div class="card-body">
                <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.dashboard.jawaban.edit', $isi_kuisoner->id) }}" class="btn btn-info">Edit</a>
                                            <button class="btn btn-danger deleteButton" value="{{ $isi_kuisoner->id }}">Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
