...
@section('content')
<h2 class="text-center"><b>Ups, Kamu Sudah Mengisi Pantauan Bulan Ini !</b> <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-emoji-smile" viewBox="0 0 16 16">
